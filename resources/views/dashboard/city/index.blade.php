...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            <a href="{{route('cities.create')}}" class="btn btn-warning font-weight-bold mr-2">
                <i class="fa fa-plus"></i>اضـافـه</a>
            <form action="{{ route('cities.deletes') }}" method="post" id="deletesData">
        ...
        <div class="card-body">
            {!! $dataTable->table() !!}
            <button type="submit" class="btn btn-danger pull-right btnDeleteAll">حذف</button>
        </div>
    </div>
    </form>
